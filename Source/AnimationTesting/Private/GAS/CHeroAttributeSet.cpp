...
void UCHeroAttributeSet::GetLifetimeReplicatedProps(TArray<class FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION_NOTIFY(UCHeroAttributeSet, Soul, COND_None, REPNOTIFY_Always);
}
...
void UCHeroAttributeSet::OnRep_Soul(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UCHeroAttributeSet, Soul , OldValue);
}
